...
using InmobiliariasHomeCo.Concret.SQL.Polls;
using InmobiliariasHomeCo.Abstract.Clients;
using InmobiliariasHomeCo.Abstract.BusinessPartners;
using InmobiliariasHomeCo.Concret.SQL.BusinessPartner;
using InmobiliariasHomeCo.Abstract.Email;
using InmobiliariasHomeCo.Concret.SQL.Email;
...
namespace InmobiliariasHomeCo.Concret.SQL
{
    public class DataBaseSQL : IDataAccess
    {
        ...
        public IDataAccessPolls DataAccessPolls
        {
            get
            {
                return new DataAccesPolls();
            }
        }

        public IDataAccessClient DataAccessClient
        {
            get
            {
        ...
        public IDataAccessBusinessPartner DataAccessBusinessPartner
        {
            get
            {
                return new DataAccessBusinessPartner();
            }
        }

        public IDataAccessEmail DataAccessEmail
        {
            get
            {
                return new DataAccessEmail();
            }
        }
    }
}
