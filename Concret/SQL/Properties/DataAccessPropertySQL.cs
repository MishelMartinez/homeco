    ...
    public class DataAccessPropertySQL : IDataAccessProperty
    {
        ...
        public string DeleteRol(int Id_User)
        {
            using (SqlConnection connection = new SqlConnection(App.ConnectionString))
            {
                ...
                SqlCommand command = new SqlCommand(query, connection);
                command.CommandType = CommandType.StoredProcedure;
                command.Parameters.Add(new SqlParameter("@IdRole", Id_User));
                try
                {
                    SqlDataReader dr = command.ExecuteReader();
                    string json = "";
        ...
        public string GetRolesForUser(int Id_User)
        {
            ...
            {
                connection.Open();
                string query = "sp_GetRolesForUser";
        ...
        public string SetRolUser(int Id_User, int Id_Role)
        {
            using (SqlConnection connection = new SqlConnection(App.ConnectionString))
            {
                ...
                command.CommandType = CommandType.StoredProcedure;
                command.Parameters.Add(new SqlParameter("@Id_User", Id_User));
                command.Parameters.Add(new SqlParameter("@Id_Role", Id_Role));
        ...
        public string SetUser(string NameUser, string FullName, string IsEnabled, string Email, string Passsword)
        {
            ...
            using (SqlConnection connection = new SqlConnection(App.ConnectionString))
            {
                ...
                SqlCommand command = new SqlCommand(query, connection);
                command.CommandType = CommandType.StoredProcedure;
                command.Parameters.Add(new SqlParameter("@NameUser", NameUser));
                command.Parameters.Add(new SqlParameter("@FullName", FullName));
                command.Parameters.Add(new SqlParameter("@IsEnabled", IsEnabled));
                command.Parameters.Add(new SqlParameter("@Email", Email));
                command.Parameters.Add(new SqlParameter("@Passsword", Passsword));
        ...
        public string UpdateUser(int Id_User, string NameUser, string FullName, string IsEnabled, string Email, string Passsword)
        {
            using (SqlConnection connection = new SqlConnection(App.ConnectionString))
            {
                ...
                SqlCommand command = new SqlCommand(query, connection);
                command.CommandType = CommandType.StoredProcedure;
                command.Parameters.Add(new SqlParameter("@UserName", NameUser));
                command.Parameters.Add(new SqlParameter("@FullName", FullName));
                command.Parameters.Add(new SqlParameter("@IsEnabled", IsEnabled));
                command.Parameters.Add(new SqlParameter("@Email", Email));
                command.Parameters.Add(new SqlParameter("@Password", Passsword));
                command.Parameters.Add(new SqlParameter("@Id_User", Id_User));
                string Verificacion = "UpdateState";
                try
                {
