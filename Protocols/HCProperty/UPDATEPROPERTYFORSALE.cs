...
{
    public class UPDATEPROPERTYFORSALE : JsonSubCommand<PropertyMessage>
    {
        protected override void ExecuteJsonCommand(WebSocketSession session, PropertyMessage commandInfo)
        {
            ...
            session.Send(String.Format("{0}", App.DataAccess.DataAccessProperty.UpdatePropertyForSale(
                ...
                string.Concat(commandInfo.Others),
                    ...
                    Terrace1,              //74   int
                    Garden1,               //73   int
                    int.Parse(commandInfo.Amount),
                    int.Parse(commandInfo.PriceM2),
                ...
                string.Concat(commandInfo.DeliveryPeriod),
                    int.Parse(commandInfo.Advance),
                string.Concat(commandInfo.Builder),
                string.Concat(commandInfo.Development),
                string.Concat(commandInfo.DirectOwner),
                string.Concat(commandInfo.Other),
