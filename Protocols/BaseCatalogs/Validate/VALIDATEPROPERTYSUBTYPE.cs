...
namespace InmobiliariasHomeCo.Protocols.BaseCatalogs.Validate
{
    public class VALIDATEPROPERTYSUBTYPE : JsonSubCommand<PropertyMessage>
    {
        protected override void ExecuteJsonCommand(WebSocketSession session, PropertyMessage commandInfo)
        {
            ...
            session.Send(String.Format("{0}", App.DataAccess.DataAccessProperty.ValidatePropertySubTypeZone(
